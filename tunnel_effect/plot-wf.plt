...
unset xtics
unset cbtics
splot 'tunnel-wf.dat' index 0 u 1:2:3
unset label
...
unset ytics
set cbtics
splot 'tunnel-wf.dat' index 45 u 1:2:3
unset label
...
set ytics
unset cbtics
splot 'tunnel-wf.dat' index 90 u 1:2:3
unset label
...
unset ytics
set cbtics
splot 'tunnel-wf.dat' index 135 u 1:2:3
unset label
